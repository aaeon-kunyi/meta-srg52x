...
version_message="1.20201030: SRG-3352x"
...
spl="MLO-am335x_evm-v2019.04-r13"
...
reset_leds() {
  local leds_pattern1=${1:-none}
  local leds_pattern2=${1:-none}
  local leds_pattern3=${1:-none}
  local leds_pattern4=${1:-none}
  local leds_base=/sys/class/led/srt3352\:led
  ...
  if [ -e ${leds_base}0/trigger ] ; then
    ...
    echo $leds_pattern4 > ${leds_base}4/trigger
  fi
}
